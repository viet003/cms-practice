...
export default function HomeClient() {
  ...
  return (
    <div className="w-full">
      {/* First Feature Section: Create. Manage. Publish */}
              ...
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-2xl">
                ...
                <Image
                  ...
                  className={`w-full h-auto rounded-2xl transition-opacity duration-300 ${
                    imageLoading.feat1 ? 'opacity-0' : 'opacity-100'
                  }`}
            ...
            <div className="flex-1 flex justify-center lg:justify-end w-full">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-2xl">
                ...
                <Image
                  ...
                  height={400}
                  className={`w-full h-auto rounded-2xl transition-opacity duration-300 ${
                    imageLoading.feat2 ? 'opacity-0' : 'opacity-100'
                  }`}
            ...
            <div className="flex-1 flex justify-center lg:justify-start order-2 lg:order-1 w-full">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-2xl">
                ...
                <Image
                  ...
                  height={400}
                  className={`w-full h-auto rounded-2xl transition-opacity duration-300 ${
                    imageLoading.feat3 ? 'opacity-0' : 'opacity-100'
                  }`}
            ...
            <div className="flex-1 flex justify-center lg:justify-end w-full">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-2xl">
                ...
                <Image
                  ...
                  height={400}
                  className={`w-full h-auto rounded-2xl transition-opacity duration-300 ${
                    imageLoading.feat4 ? 'opacity-0' : 'opacity-100'
                  }`}
            ...
            <div className="flex-1 flex justify-center lg:justify-start order-2 lg:order-1 w-full">
              <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-2xl">
                ...
                <Image
                  ...
                  height={400}
                  className={`w-full h-auto rounded-2xl transition-opacity duration-300 ${
                    imageLoading.feat5 ? 'opacity-0' : 'opacity-100'
                  }`}
