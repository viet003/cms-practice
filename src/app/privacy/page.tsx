...
// Custom Skeleton components to replace Antd Skeleton
      ...
      <section className="py-8 sm:py-12 lg:py-20 px-4 text-center bg-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 w-full">
            {imageLoading.hero ? (
              <SkeletonImage 
                className="!w-full !h-64 sm:!w-full sm:!h-72 md:!w-full md:!h-80"
              />
            ) : null}
            <Image
      ...
      <section className="py-8 sm:py-12 lg:py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {imageLoading.contentControl ? (
            <SkeletonImage 
              className="!w-full !h-80 sm:!w-full sm:!h-96 md:!w-full md:!h-[400px]"
            />
          ) : null}
          <Image
