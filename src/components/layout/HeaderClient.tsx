...
const HeaderClient: React.FC<HeaderProps> = ({ logo: headerLogo, subLogo, siteTitle }) => {
  ...
  return (
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-[60] w-full ${
        isScrolled ? 'backdrop-blur-lg bg-white/95 border-b border-gray-200' : 'bg-transparent'
      }`}>
